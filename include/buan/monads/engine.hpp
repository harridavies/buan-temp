...
public:
    BuanEngine(IPortal& portal, BuanRingBuffer<BuanDescriptor, 1024>& ring, BuanRingBuffer<BuanAuditDescriptor, 8192>& audit_ring)
        : m_portal(portal), m_ring(ring), m_audit_ring(audit_ring) {}
